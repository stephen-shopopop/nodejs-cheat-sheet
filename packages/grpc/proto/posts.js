...
$root.Posts = (function() {
    ...
    Posts.decode = function decode(reader, length) {
        ...
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.Posts();
    ...
    Posts.fromObject = function fromObject(object) {
        if (object instanceof $root.Posts)
            return object;
...
$root.PostsId = (function() {
    ...
    PostsId.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.PostsId();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    PostsId.fromObject = function fromObject(object) {
        if (object instanceof $root.PostsId)
            return object;
...
$root.PostsList = (function() {
    ...
    PostsList.encode = function encode(message, writer) {
        ...
        if (message.posts != null && message.posts.length)
            for (var i = 0; i < message.posts.length; ++i)
                $root.Posts.encode(message.posts[i], writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
        return writer;
    };
    ...
    PostsList.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.PostsList();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    PostsList.fromObject = function fromObject(object) {
        if (object instanceof $root.PostsList)
            return object;
        var message = new $root.PostsList();
        if (object.posts) {
            if (!Array.isArray(object.posts))
                throw TypeError(".PostsList.posts: array expected");
            message.posts = [];
            for (var i = 0; i < object.posts.length; ++i) {
                if (typeof object.posts[i] !== "object")
                    throw TypeError(".PostsList.posts: object expected");
    ...
    PostsList.toObject = function toObject(message, options) {
        ...
        if (message.posts && message.posts.length) {
            ...
            for (var j = 0; j < message.posts.length; ++j)
                object.posts[j] = $root.Posts.toObject(message.posts[j], options);
        }
        return object;
    };
